...
def get_vxm_model(fixed_image, loss='MSE', learning_rate=0.001):
...
class VoxelmorphTF(ImageRegistrationInterface):
    ...
    def register_images(
            ...
            weights_path='/home/lschilling/PycharmProjects/image_registration_thesis/models/vxm_mnist.index',
            loss='MSE') -> {sitk.Image, sitk.Image, int}:
